...
def main():
    ...
    for i_episode in range(episodes):
        embedding_list,action_list,reward_list = gamerun(env,encoder)
        blackbox_nn_train(embedding_list,action_list,reward_list)
        print('Episode {} finished'.format(i_episode))
    env.close()


def blackbox_nn_train(embedding_list,action_list,reward_list):
    #TODO
    pass
...
def gamerun(env,encoder):
    ...
    return embedding_list[:counter+4],action_list[:counter+4],reward_list[:counter+4]
